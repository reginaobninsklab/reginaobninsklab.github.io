---
title: "Образы еды и напитков в ТГ-каналах калужских лидеров мнения"
description: |
  Подсчитываем emoji категории Foods & Drinks в ТГ-каналах калужских политиков, чиновников, журналистов, медийных персон и общественных организаций.  
date: 2024-04-04
categories:
  - сми
  - телеграм
...
В [первой части](https://reginaobninsklab.github.io/posts/kaluga-kols-tg-part1/){target="_blank"} мы рассматривали использование в телеграмм-каналах наречий, во второй -- перешли на использование образов животных и растений посредством emoji.

Следующие по силе воздействия на сознание масс -- образы еды и выпивки. Если древние люди падали ниц при виде рисунка лошади или уходили в рощи обнимать берёзки, то для многих из наших современников образ рая -- это all inclusive extra plus с  круглосуточным шведским столом и бесплатным алкоголем.
...
emos |> filter(n_channels<=4) |> 
  ...
  datatable(rownames = F, class = 'compact striped', 
    ...
    paste0('Таблица 1. Наиболее часто употребимые emoji категории Foods & Drinks из исследуемых ТГ-каналов.')), 
...
ch1_filename <- paste0(dir, "net_emoji_food.png")
ch1_blogfile <- paste0(dir_charts, "kaluga_tg_food.png")
if(!file.exists(ch1_blogfile)){ s<- file.copy(from = ch1_filename, to = ch1_blogfile, overwrite = T) }
knitr::include_graphics(ch1_blogfile)
```

P.S. У нескольких каналов появляется emoji с изображением ножа -- это вряд ли о еде (у одного из каналов в названии ЧП), но мы решили оставить, как и другие столовые приборы.
...
Образы еды и напитков в ТГ-каналах калужских лидеров мнения // Блог Regina Lab. - 2024. - URL: https://reginaobninsklab.github.io/posts/kaluga-kols-tg-food/. - Дата публикации: 4 апреля 2024 г.
